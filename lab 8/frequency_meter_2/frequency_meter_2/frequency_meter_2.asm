...
//intialization for the timer
	...
	ldi r16, $3C						;load the counter with 15625
...
reset:
	...
	ldi r16, $00
	out ddrd, r16						;set up the port b as inputs to read the pbsw 
										;values
	...
	out ddra, r16						;read the frequency input on pa7 and output pulse
										; on pa6
...
line3_message0:	.db 3, "FM1****HZ***1SEC", 0  ; test string for line #3.

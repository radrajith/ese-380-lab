 ...
 * is a logic 0, the led is off. unlike the previous 
 * lab, this program is modified to utilize the pull up
 * resistor found inside the chip, and eliminate the 10k
 * ohm external resistor pack.
 *
 ...
 */ 
 ...
 reset:
	...
	//this initializes regsters and configures the pin. pins in portb are set to output. 
	//pins in port d are set as inputs, and set port d pins as outputs and enable the pull 
	//up resistors.
	
	ldi r16, $FF				;initialize register 16, with all 1's
	...
	out PortD, r16				;this activates the pull up resistors in port d

again:
	;Infinite loop... Input to switch values, and output to LEDs
	// reads the swiches and ouputs to the led. 

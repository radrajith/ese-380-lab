...
reset:
	...
	ldi r19, 0b10					;load r19 with 01 to turn on led				
...
check_load:
	...
	rjmp main_loop					;if not pressed go to main loop
	sbrs r22, 0						;check wether select button is pressed
	rcall selectingnibble			;if not pressed automatically switch the nibbles
	clr r22							;clear bits in r22
...
selectingnibble:
	...
	sbrs r19,0						;skip if bit 0 is 0, indicating upper nibble

 ...
 *
 ...
 ; dip switch. The difference in this bonus is that after pressing 
 ; load push button it will immediately switch to the other nibble 
 ; so that the next load push will load the other nibble
 ;
...
switch:
	...
	clear:
	sbi pina, 6						;generate pulse 
	cbi pina, 6						;to clear register
	wait_0:
	sbic pinc,7
	rjmp wait_0
LOAD_push:
	...
	sbis pina, 0					;dont swap if the first bit is selected

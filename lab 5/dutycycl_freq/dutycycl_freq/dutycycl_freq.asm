...
//	ldi r16, 0						;load with 0 to compare with swtich
	...
	rcall frequency					;go to frequency and return
...
//	ldi r16, $f						;load r16 with 1's
	andi r25, 0b11110000			;obtain only the 4 msb
	ldi r16, 100					;load r16 with 100
	sub r16, r25 					;subtract r25 from 16 
...
delay_on:
	pop r20							;load r20 with values of r25
...
delay_off:
	pop r20							;load r20 with value of r25
//	ldi r20, 100					;load r20 with 100
